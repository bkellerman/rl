...
class DQNLunar2Solver():
    ...
    def replay(self, batch_size):
        ...
        self.online_model.fit(x_batch, y_batch, batch_size=len(x_batch), epochs=2, verbose=0)
    ...
    def target_replay(self, batch_size):
        ...
        x_batch = np.array(x_batch)
        y_batch = np.array(y_batch)
        model_to_update.fit(x_batch, y_batch, batch_size=len(x_batch), epochs=1, verbose=0)
...
if __name__ == '__main__':
    agent = DQNLunar2Solver(n_episodes=10000000)
    agent.run()
